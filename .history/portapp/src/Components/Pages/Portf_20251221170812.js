...
const Hero = () => {
  ...
  >
    ...
    {/* ✅ MISSING WRAPPER — THIS FIXES THE ERROR */}
    <motion.div
      style={{ y, opacity }}
      className="relative z-10 text-center px-6 max-w-5xl mx-auto"
    >
      <motion.div className="mb-6 inline-block">
        <div className="w-32 h-32 mx-auto bg-gradient-to-br from-gray-900 to-gray-600 rounded-full flex items-center justify-center shadow-xl overflow-hidden">
          <motion.img
            src="/images/dari.png"
            alt="Profile"
      ...
      <div className="flex flex-wrap justify-center gap-3 mb-6">
        {["Full Stack Developer", "Machine Learning Engineer", "Problem Solver"].map(
          (role, idx) => (
            <motion.span
              key={idx}
