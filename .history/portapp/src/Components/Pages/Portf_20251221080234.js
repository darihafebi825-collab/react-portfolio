...
const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      tech: ['React', 'JavaScript', 'Python', 'MySQL'],
  ...
  return (
    <section
      id="experience"
      className="py-24 bg-gradient-to-b from-gray-100 to-white relative overflow-hidden"
    >
      {/* Map-style grid background */}
      <div
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            A location-style view of my professional journey
          </p>
        </motion.div>
          ...
          {experiences.map((exp, idx) => (
            ...
            >
              ...
              <motion.div
                ...
                className="bg-white border border-gray-200 rounded-xl p-6 w-full transition-all"
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {exp.tech.map((t, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 text-xs bg-gray-900 text-white rounded-full"
                    >
                      {t}
                    </span>
                  ))}
