  ...
  const experiences = [
    ...
    },
    {
      ...
      responsibilities: [
        ...
        'Fixed bugs and shipped new features',
        'Worked closely with designers for pixel-perfect UI'
      ],
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex items-center justify-between mb-20">
          <motion.div
            ...
            className="bg-gray-700 p-6 rounded-2xl shadow-xl"
          >
            <Briefcase size={44} className="text-gray-100" />
          </motion.div>
          ...
          >
            ...
            <div className="h-1.5 w-24 bg-gray-800 ml-auto mb-4 rounded-full" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {experiences.map((exp, idx) => (
            ...
            >
              <div className="relative bg-gray-50 border border-gray-300 rounded-xl p-6 shadow-lg">

                {/* Paper Fold */}
                <div
                  className="absolute top-0 right-0 w-12 h-12 bg-gray-100 border-l border-b border-gray-300"
                  style={{ clipPath: 'polygon(0 0, 100% 100%, 100% 0)' }}
                />

                {/* Index */}
                <div className="absolute -top-4 -right-4 w-12 h-12 rounded-full bg-gray-700 text-gray-100 flex items-center justify-center text-lg font-bold shadow-md">
                  {idx + 1}
                </div>

                {/* Title */}
                <div className="border-l-4 border-gray-700 pl-4 mb-4">
                ...
                <div className="flex flex-wrap gap-2 mb-4 text-xs">
                  <span className="flex items-center gap-1 bg-gray-100 px-3 py-1.5 rounded-md border border-gray-300">
                    <Calendar size={12} />
                    {exp.period}
                  </span>
                  <span className="flex items-center gap-1 bg-gray-200 px-3 py-1.5 rounded-md">
                    <MapPin size={12} />
                    {exp.location}
                  </span>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {exp.tech.slice(0, 5).map((t, i) => (
                    <span
                      key={i}
                      className="px-2.5 py-1 text-xs bg-gray-700 text-gray-100 rounded-md shadow-sm"
                    >
                      {t}
                    </span>
                  ))}
                  {exp.tech.length > 5 && (
                    <span className="px-2.5 py-1 text-xs bg-gray-200 text-gray-700 rounded-md">
                      +{exp.tech.length - 5}
                    </span>
                  )}
                </div>
