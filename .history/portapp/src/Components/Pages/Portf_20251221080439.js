    ...
    <section className="relative bg-white py-32">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          <h2 className="text-6xl font-serif font-bold text-gray-900 tracking-tight mb-2">
            Professional Chronicle
          </h2>
          <p className="text-gray-600 text-lg italic">
            A magazine-style showcase of my career journey
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {experiences.map((exp, idx) => (
            <div
              key={idx}
              className="relative group border-l-4 border-gray-900 pl-6 py-6 hover:shadow-lg transition-shadow duration-300"
            >
              {/* Decorative line at top */}
              <div className="absolute -top-4 left-0 w-12 h-1 bg-gray-900" />
