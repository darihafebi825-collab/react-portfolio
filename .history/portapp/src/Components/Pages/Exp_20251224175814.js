    ...
    <section className="min-h-screen bg-gray-50 relative py-20 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
        ...
        <div className="relative flex justify-center items-center min-h-[600px]">
          ...
          {/* Floating Skill Icons: scattered horizontally */}
          {skills.map((skill, idx) => {
            const offsetX = (Math.random() - 0.5) * 400; // random left/right
            const offsetY = 0; // no vertical scatter
            ...
            return (
              <motion.img
                ...
                animate={{ scale: 1, opacity: 1, x: offsetX, y: offsetY }}
