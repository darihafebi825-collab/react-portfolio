        ...
        <div className="flex gap-4 overflow-x-auto scrollbar-hide py-4">
          {projects.map((project, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="min-w-[250px] flex-shrink-0 bg-white rounded-lg shadow-md overflow-hidden border border-blue-200 hover:shadow-lg transition-shadow"
            >
              <div className="aspect-video bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center text-6xl">
                {project.image}
              </div>
              ...
              <div className="p-4">
                ...
                <div className="mb-3">
                  <div className="text-xs text-blue-700 uppercase tracking-wider mb-1 font-semibold">Key Features</div>
                  <div className="grid grid-cols-2 gap-1">
                    {project.features.map((feature, i) => (
                      <div key={i} className="text-xs text-gray-700 flex items-center gap-1">
                        <Star size={10} className="text-blue-700" /> {feature}
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-1 mb-3">
                  {project.tech.map((t, i) => (
                    <span key={i} className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded font-medium">
                      {t}
                    </span>
                  ))}
                </div>
                ...
                <div className="flex gap-2">
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-1.5 bg-blue-700 text-white rounded text-sm font-medium">
                    <Github size={16} /> Code
                  </motion.a>
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-1.5 bg-white border-2 border-blue-700 text-blue-700 rounded text-sm font-medium">
