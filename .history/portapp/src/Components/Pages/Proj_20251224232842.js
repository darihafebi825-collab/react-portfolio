      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex gap-6 overflow-x-auto scrollbar-hide py-4 px-2">
          {projects.map((project, idx) => (
            ...
            >
              {/* Project Image/Icon */}
              <div className="h-48 bg-gradient-to-br from-gray-900 to-gray-700 flex items-center justify-center text-7xl">
                {project.image}
              </div>
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <p className="text-gray-600 text-base mb-4 leading-relaxed line-clamp-3">{project.description}</p>
