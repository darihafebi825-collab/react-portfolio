...
import { Code2, Github, ExternalLink, Star, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <section id="projects" className="py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="w-20 h-1 bg-gray-900 mx-auto mb-4" />
          <p className="text-gray-600 max-w-2xl mx-auto">
            Scroll horizontally to explore my portfolio of innovative projects
          </p>
        </motion.div>
        ...
        <div className="relative">
          ...
          {canScrollLeft && (
            <button
              onClick={() => scroll('left')}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-gray-900 text-white p-3 rounded-full shadow-xl hover:bg-gray-800 transition-all"
            >
              <ChevronLeft size={24} />
            </button>
          )}
          ...
          {canScrollRight && (
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-gray-900 text-white p-3 rounded-full shadow-xl hover:bg-gray-800 transition-all"
            >
          ...
          <div
            ...
            className="flex gap-8 overflow-x-auto scrollbar-hide py-4 px-2 scroll-smooth"
          ...
          >
            {projects.map((project, idx) => (
              <motion.div
                ...
                className="flex-shrink-0 w-[500px] bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-gray-200 hover:border-gray-900 hover:shadow-2xl transition-all duration-300"
              >
                {/* Header with Icon */}
                <div className="relative h-48 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 flex items-center justify-center">
                  <div className="absolute top-4 left-4 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
                ...
                <div className="p-6">
                  {/* Category Badge */}
                  <div className="mb-3">
                    <span className="inline-block text-xs font-bold text-gray-900 uppercase tracking-wider bg-gray-100 px-3 py-1.5 rounded-full">
                      {project.category}
                    </span>
                  </div>
                  ...
                  <div className="mb-4">
                    <h4 className="text-xs font-bold text-gray-900 uppercase tracking-wider mb-3 flex items-center gap-2">
                      <Star size={14} className="text-gray-900" /> Key Features
                    </h4>
                  ...
                  <div className="mb-5">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tech.slice(0, 4).map((t, i) => (
                        <span
                          key={i}
                          className="px-3 py-1 bg-gray-900 text-white text-xs font-semibold rounded-md"
                        >
                          {t}
                        </span>
                      ))}
                  ...
                  <div className="flex gap-3">
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      href="#"
                      className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-gray-900 text-white rounded-lg text-sm font-semibold hover:bg-gray-800 transition-colors"
                    >
                      <Github size={16} /> Code
                    </motion.a>
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      href="#"
                      className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border-2 border-gray-900 text-gray-900 rounded-lg text-sm font-semibold hover:bg-gray-900 hover:text-white transition-all"
                    >
