...
const Skills = () => {
  ...
  skills: [
    ...
    { name: 'Django', level: 88, color: 'bg-green-700' },
    { name: 'SQLite', level: 85, color: 'bg-yellow-500' },
    { name: 'REST APIs', level: 87, color: 'bg-indigo-500' },
    { name: 'ORM', level: 82, color: 'bg-gray-700' }
  ]
},
   {
  ...
  skills: [
    ...
    { name: 'Pandas', level: 90, color: 'bg-green-500' },
    { name: 'NumPy', level: 92, color: 'bg-yellow-400' },
    { name: 'Scikit-Learn', level: 88, color: 'bg-indigo-500' },
    { name: 'TensorFlow', level: 85, color: 'bg-red-500' },
    { name: 'PyTorch', level: 80, color: 'bg-pink-500' },
    { name: 'Data Visualization', level: 90, color: 'bg-cyan-400' },
...
import { Code, Database, Cpu, Wrench, X } from 'lucide-react';
          ...
          {activeSkill !== null && (
            <>
              ...
              <motion.div
                ...
                className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-md bg-[#1a1f2e] border-2 border-gray-600 rounded-2xl p-8 z-50 shadow-2xl"
              >
                {/* Close button */}
                <button
                  onClick={() => setActiveSkill(null)}
