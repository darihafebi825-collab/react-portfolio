    ...
    <section id="projects" className="py-24 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          ...
          className="mb-20"
        >
          <h2 className="text-7xl md:text-8xl font-black text-gray-900 mb-2">
            FEATURED
          </h2>
          <h2 className="text-7xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-500">
            WORK
          </h2>
        </motion.div>
          ...
          {projects.map((project, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-900 to-gray-700 rounded-2xl transform rotate-3 group-hover:rotate-6 transition-transform" />
                  <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-12 flex items-center justify-center h-80 border-4 border-gray-900">
                    <div className="text-9xl transform group-hover:scale-110 transition-transform">
                      {project.image}
                    </div>
                    <div className="absolute top-6 right-6 bg-gray-900 text-white px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider">
                      0{idx + 1}
                    </div>
                  </div>
                </motion.div>
                ...
                <div className="w-full md:w-1/2 space-y-6">
                  <div>
                    <div className="text-sm font-black text-gray-500 uppercase tracking-widest mb-3">
                      {project.category}
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="font-black text-xs uppercase tracking-widest text-gray-900">
                      Tech Stack
                    </div>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div className="flex gap-4 pt-4">
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      href="#"
                      className="flex items-center gap-2 px-8 py-4 bg-gray-900 text-white font-bold rounded-xl hover:bg-gray-800 transition-colors"
                    >
                    ...
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      href="#"
                      className="flex items-center gap-2 px-8 py-4 border-4 border-gray-900 text-gray-900 font-bold rounded-xl hover:bg-gray-900 hover:text-white transition-colors"
                    >
