...
import { Star, Github, ExternalLink, Code2 } from "lucide-react";
  ...
  return (
    <section id="projects" className="py-24 bg-[#eef1f5]">
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        {/* Horizontal scrollable cards with title at the far right */}
        <div className="flex gap-6 overflow-x-auto scrollbar-hide py-4 items-start">
          ...
          {/* Title at the far right */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="flex-shrink-0 flex flex-col items-end justify-center w-[280px]"
          >
