  ...
  const experiences = [
    {
      ...
      description:
        "Built dynamic UI components and implemented routing in React.",
      tech: [
        "React JS",
        "JavaScript (ES6+)",
        "HTML5",
    ...
    },
    {
      ...
      location: "Technopark, Trivandrum",
      description:
        "Contributed to training and testing models for yoga pose recognition.",
      tech: [
        "Python",
        "TensorFlow",
        "Keras",
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex items-center justify-between mb-20">
          ...
          >
            ...
            <motion.div
              ...
              className="h-1.5 bg-gray-900 md:ml-auto mb-4 rounded-full"
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          {experiences.map((exp, idx) => (
            ...
            >
              <div className="relative bg-gradient-to-b from-gray-50 to-gray-200 rounded-xl p-6 shadow-xl border border-gray-300 overflow-hidden">
                ...
                <div className="pt-2">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="flex items-center gap-1 bg-gray-100 px-3 py-1.5 rounded-lg text-xs border">
                      <Calendar size={12} />
                      {exp.period}
                    </span>
                    <span className="flex items-center gap-1 bg-gray-800 text-gray-100 px-3 py-1.5 rounded-lg text-xs">
                      <MapPin size={12} />
                      {exp.location}
                    </span>
                  </div>

                  <p className="text-sm text-gray-700 mb-3 pl-3 border-l-2 border-gray-800 italic">
                    {exp.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.tech.slice(0, 5).map((t, i) => (
                      <span
                        key={i}
                        className="px-2.5 py-1 bg-gray-800 text-gray-100 text-xs rounded-lg"
                      >
                        {t}
                      </span>
                    ))}
                    {exp.tech.length > 5 && (
                      <span className="px-2.5 py-1 bg-gray-200 text-gray-700 text-xs rounded-lg">
                        +{exp.tech.length - 5}
                      </span>
                    )}
                  </div>
