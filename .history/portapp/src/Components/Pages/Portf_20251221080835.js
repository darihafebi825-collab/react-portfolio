...
const ExperienceCard = ({ exp, idx }) => {
  const zOffset = window.innerWidth < 768 ? idx * 10 : idx * 30;
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        transform: `translateZ(${zOffset}px) rotateY(${idx % 2 === 0 ? "5" : "-5"}deg)`,
      }}
    >
      <motion.div
        whileHover={{ y: -20, rotateX: -5, transition: { duration: 0.3 } }}
        className="relative"
        style={{ transformStyle: "preserve-3d" }}
      >
        {/* Shadow */}
        <div
          className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 w-4/5 h-8 bg-black/30 rounded-full blur-2xl"
          style={{ transform: "translateZ(-80px) scale(1.2)" }}
        />

        {/* Platform floor */}
        <div
          className="absolute -bottom-6 left-0 right-0 h-3 bg-gradient-to-b from-gray-400 to-gray-500 rounded-t-lg"
          style={{ transform: "translateZ(-40px) rotateX(90deg)", transformOrigin: "top" }}
        />

        {/* Platform sides */}
        <div
          className="absolute -bottom-6 left-0 w-3 h-12 bg-gradient-to-r from-gray-500 to-gray-600"
          style={{ transform: "translateZ(-40px) rotateY(-90deg)", transformOrigin: "right" }}
        />
        <div
          className="absolute -bottom-6 right-0 w-3 h-12 bg-gradient-to-l from-gray-500 to-gray-600"
          style={{ transform: "translateZ(-40px) rotateY(90deg)", transformOrigin: "left" }}
        />

        {/* Main Card */}
        <div
          className="relative bg-white rounded-xl p-6 shadow-2xl border-2 border-gray-200 overflow-hidden group"
          style={{
            transformStyle: "preserve-3d",
            boxShadow: "0 30px 60px rgba(0,0,0,0.3), 0 0 0 1px rgba(0,0,0,0.1)",
          }}
        >
          {/* Glowing top edge */}
          ...
          <motion.div
            ...
            className={`absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-br ${exp.color} rounded-full flex items-center justify-center font-bold text-2xl text-white shadow-2xl border-4 border-white`}
          ...
          <div className="relative z-10 pt-2">
            ...
            <div className="flex items-start gap-3 mb-4">
              <motion.div
                ...
                transition={{ duration: 0.6 }}
                className={`bg-gradient-to-br ${exp.color} p-3 rounded-xl shadow-lg`}
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="flex items-center gap-1.5 bg-gray-100 px-3 py-1.5 rounded-lg text-xs font-medium border border-gray-200">
                <Calendar size={12} />
                {exp.period}
              </span>
              <span className={`flex items-center gap-1.5 bg-gradient-to-r ${exp.color} text-white px-3 py-1.5 rounded-lg text-xs font-medium shadow-md`}>
                <MapPin size={12} />
                {exp.location}
              </span>
            </div>
            ...
            {/* Description */}
            <p className="text-sm text-gray-700 mb-3 pl-3 border-l-2 border-gray-900 italic leading-relaxed">
              {exp.description}
            </p>
              ...
              <ul className="space-y-1.5 mb-4">
                {exp.responsibilities.map((resp, i) => (
                  <motion.li
                    ...
                    transition={{ delay: idx * 0.2 + 0.1 * i }}
            ...
            <div className="flex flex-wrap gap-2">
              {exp.tech.slice(0, 5).map((t, i) => (
                <motion.span
                  ...
                  transition={{ delay: idx * 0.2 + 0.05 * i, type: "spring" }}
                  whileHover={{ scale: 1.1, y: -3, transition: { duration: 0.2 } }}
                  className="px-2.5 py-1 bg-gray-900 text-white text-xs rounded-lg font-medium shadow-md hover:shadow-xl transition-shadow"
                  style={{ transformStyle: "preserve-3d" }}
                >
                  {t}
                </motion.span>
          ...
          {/* 3D depth lines */}
          <div
            className={`absolute top-0 right-0 w-2 h-full bg-gradient-to-b ${exp.color} opacity-20`}
            style={{ transform: "translateZ(-5px) rotateY(90deg)", transformOrigin: "left" }}
          />
          <div
            className={`absolute bottom-0 left-0 right-0 h-2 bg-gradient-to-r ${exp.color} opacity-20`}
            style={{ transform: "translateZ(-5px) rotateX(90deg)", transformOrigin: "top" }}
          />
        </motion.div>
      </motion.div>
    </motion.div>
