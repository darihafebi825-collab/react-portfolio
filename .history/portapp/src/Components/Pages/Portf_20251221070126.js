...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-32 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
      {/* 3D Grid floor */}
      ...
      {/* Horizon glow */}
      <div className="absolute bottom-0 left-0 right-0 h-64 bg-gradient-to-t from-blue-500/20 via-purple-500/10 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            <div className="bg-gradient-to-br from-white to-gray-200 p-6 rounded-2xl shadow-2xl">
          ...
          <motion.div 
            ...
            className="h-1.5 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 mx-auto mb-4 rounded-full"
          />
          <p className="text-gray-300 max-w-2xl mx-auto text-lg">
            My professional journey in 3D space
          </p>
        </motion.div>
        
        {/* 3D Standing cards container */}
        <div className="relative" style={{
          perspective: '1500px',
          perspectiveOrigin: 'center 60%'
        }}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 items-end" style={{
            ...
            {experiences.map((exp, idx) => (
              ...
              >
                {/* Floor shadow */}
                <div 
                  className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 w-full h-24 bg-black/40 rounded-full blur-3xl"
                  style={{
                    transform: 'translateZ(-100px) rotateX(90deg) scale(1.5)',
                    transformOrigin: 'center'
                  }}
                />
                
                {/* 3D Card standing upright */}
                <div 
                ...
                >
                  {/* Top colored edge */}
                  <div 
                    className={`absolute top-0 left-0 right-0 h-16 bg-gradient-to-r ${exp.color}`}
                    style={{
                      transformStyle: 'preserve-3d'
                    }}
                  >
                    {/* Top face */}
                    <div 
                      className={`absolute inset-0 bg-gradient-to-br ${exp.color} opacity-80`}
                      style={{
                  ...
                  {/* Right side panel (visible depth) */}
                  <div 
                    className="absolute top-0 right-0 w-12 h-full bg-gradient-to-l from-gray-300 to-gray-200"
                    style={{
                  ...
                  <div 
                    className="absolute top-0 left-0 w-12 h-full bg-gradient-to-r from-gray-300 to-gray-200"
                    style={{
                      transform: 'translateZ(-25px) rotateY(-90deg)',
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className={`absolute -top-8 -right-6 w-20 h-20 bg-gradient-to-br ${exp.color} rounded-full flex items-center justify-center font-bold text-3xl text-white shadow-2xl border-4 border-white`}
                      style={{
                    ...
                    <div className="h-full flex flex-col pt-8">
                      ...
                      <div className="mb-6">
                        <motion.div
                          ...
                          transition={{ duration: 0.6 }}
                          className={`inline-block bg-gradient-to-br ${exp.color} p-4 rounded-xl shadow-xl mb-4`}
                          style={{
                      ...
                      <div className="flex-1 overflow-y-auto space-y-4">
                        <p className="text-sm text-gray-700 pl-3 border-l-4 border-gray-900 italic leading-relaxed">
                          {exp.description}
                        </p>
                        ...
                        <div className="flex flex-wrap gap-2 pt-2">
                          {exp.tech.slice(0, 6).map((t, i) => (
                            <motion.span
                              ...
                              className="px-3 py-1.5 bg-gray-900 text-white text-xs rounded-lg font-medium shadow-lg hover:shadow-2xl"
                              style={{
                                transformStyle: 'preserve-3d'
                              }}
                            >
                          ...
                          {exp.tech.length > 6 && (
                            <span className="px-3 py-1.5 bg-gray-200 text-gray-700 text-xs rounded-lg font-medium">
                              +{exp.tech.length - 6}
                            </span>
                          )}
                        </div>
                  ...
                  {/* Bottom edge with depth */}
                  <div 
                    className="absolute bottom-0 left-0 right-0 h-4 bg-gradient-to-b from-gray-200 to-gray-300"
                    style={{
                      transform: 'translateZ(25px)'
                    }}
                  />
