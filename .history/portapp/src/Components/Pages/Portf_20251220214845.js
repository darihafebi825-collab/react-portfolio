    ...
    <section id="projects" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="w-20 h-1 bg-blue-700 mx-auto mb-4" />
        ...
        <div className="flex gap-3 overflow-x-auto scrollbar-hide py-4">
          {projects.map((project, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="w-[200px] flex-shrink-0 bg-white rounded-lg shadow-md overflow-hidden border border-blue-200 hover:shadow-lg transition-shadow flex flex-col"
            >
              <div className="h-24 bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center text-4xl">
                {project.image}
              </div>

              <div className="p-3 flex flex-col flex-grow">
                <div className="text-xs text-blue-700 uppercase tracking-wider mb-1 font-semibold">
                  {project.category}
                </div>
                <h3 className="text-base font-bold text-gray-900 mb-1.5 line-clamp-1">{project.title}</h3>
                <p className="text-gray-600 text-xs mb-2 leading-snug line-clamp-2">{project.description}</p>

                <div className="mb-2">
                  <div className="text-xs text-blue-700 uppercase tracking-wider mb-1 font-semibold">Features</div>
                  <div className="grid grid-cols-1 gap-0.5">
                    {project.features.slice(0, 3).map((feature, i) => (
                      <div key={i} className="text-xs text-gray-700 flex items-center gap-1">
                        <Star size={8} className="text-blue-700 flex-shrink-0" /> 
                ...
                <div className="flex gap-1.5 mt-auto">
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 flex items-center justify-center gap-1 px-2 py-1 bg-blue-700 text-white rounded text-xs font-medium">
                    <Github size={12} /> Code
                  </motion.a>
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 flex items-center justify-center gap-1 px-2 py-1 bg-white border-2 border-blue-700 text-blue-700 rounded text-xs font-medium">
