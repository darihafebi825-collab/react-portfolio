    ...
    <section className="min-h-screen bg-[#eef1f5] py-24 px-6">
      <div className="max-w-4xl mx-auto relative">
        ...
        >
          ...
          <p className="mt-3 text-gray-500 tracking-wide uppercase text-sm">
            Adventure Awaits
          </p>
        </motion.div>

        {/* Timeline vertical line */}
        <div className="absolute left-1/2 top-44 bottom-0 w-1 bg-gray-300 -translate-x-1/2 rounded-full"></div>
