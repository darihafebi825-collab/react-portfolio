    ...
    <section id="projects" className="py-24 bg-gray-100 flex justify-center">
      <div className="max-w-7xl mx-auto px-6 w-full">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 flex justify-between items-center gap-3 skeuo-header p-6 rounded-xl bg-gray-100">
          ...
          <p className="text-gray-700 max-w-2xl mt-4 skeuo-card p-4 rounded-xl bg-gray-100">
        ...
        <div className="flex gap-6 overflow-x-auto scrollbar-hide py-4">
          {projects.map((project, idx) => (
            <motion.div
              ...
              className="w-80 flex-shrink-0 bg-gray-100 rounded-2xl skeuo-card overflow-hidden flex flex-col border border-gray-400"
            >
              {/* Project Image/Icon */}
              <div className="h-36 flex items-center justify-center text-6xl rounded-t-2xl skeuo-inner bg-gray-100 text-black">
                {project.image}
              </div>
              ...
              <div className="p-4 flex flex-col flex-grow skeuo-inner">
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {project.tech.slice(0, 3).map((t, i) => (
                    <span key={i} className="px-2 py-1 bg-gray-100 text-black text-sm rounded skeuo-inner">
                      {t}
                    </span>
                  ))}
                </div>
                ...
                <div className="flex gap-2 mt-auto">
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gray-100 text-gray-900 rounded skeuo-inner border border-gray-400 font-medium">
                    <Github size={16} /> Code
                  </motion.a>
                  <motion.a whileHover={{ scale: 1.05, backgroundColor: '#111', color: '#fff' }} href="#"
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gray-100 text-gray-900 rounded skeuo-inner border-2 border-gray-400 font-medium">
      ...
      <style>
        {`
          ...
          .skeuo-card:hover {
            box-shadow: 2px 2px 10px rgba(0,0,0,0.3), -2px -2px 10px rgba(255,255,255,0.9);
          }
        `}
      </style>
    </section>
