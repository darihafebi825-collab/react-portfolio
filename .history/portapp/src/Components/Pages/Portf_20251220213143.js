        ...
        <div className="flex gap-6 overflow-x-auto scrollbar-hide py-4">
          {projects.map((project, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="min-w-[280px] flex-shrink-0 bg-blue-600 text-white rounded-xl shadow-lg overflow-hidden border border-blue-700 hover:shadow-2xl transition-shadow flex flex-col h-[500px]"
            >
              {/* Image */}
              <div className="h-32 w-full flex items-center justify-center text-6xl bg-blue-700">
                {project.image}
              </div>

              {/* Content */}
              <div className="p-4 flex flex-col flex-1">
                <div className="text-xs uppercase tracking-wider mb-1 font-semibold text-blue-200">
                  {project.category}
                </div>
                ...
                <div className="mb-2">
                  <div className="text-xs uppercase tracking-wider mb-1 font-semibold text-blue-200">Key Features</div>
                ...
                <div className="flex flex-wrap gap-1 mb-3">
                  {project.tech.map((t, i) => (
                    <span key={i} className="px-2 py-1 bg-blue-800 text-white text-xs rounded font-medium">
                      {t}
                    </span>
                  ))}
                </div>
                ...
                <div className="flex gap-2 mt-auto">
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 text-center px-2 py-2 bg-blue-800 rounded-lg text-sm font-medium flex items-center justify-center gap-1">
                    <Github size={14} /> Code
                  </motion.a>
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 text-center px-2 py-2 bg-blue-100 text-blue-900 border border-blue-700 rounded-lg text-sm font-medium flex items-center justify-center gap-1">
