    ...
    <section id="experience" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div className="flex gap-8 items-start">
          ...
          <div className="hidden md:flex flex-col items-center gap-6 pt-20">
            <div className="flex flex-col items-center gap-4">
              <motion.div
                initial={{ height: 0 }}
                whileInView={{ height: 'auto' }}
                className="w-1 bg-gradient-to-b from-gray-900 to-gray-400 rounded-full"
                style={{ height: `${experiences.length * 180}px` }}
              />
            </div>
            
            {/* Timeline dots positioned absolutely */}
            <div className="absolute flex flex-col gap-[180px] pt-20">
              {experiences.map((_, idx) => (
                ...
                >
                  <motion.div
                    ...
                    className="absolute inset-0 -m-2 bg-gray-900 rounded-full"
                  />
                  <div className="w-5 h-5 bg-gray-900 rounded-full border-4 border-white shadow-lg relative z-10" />
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <div className="flex-1 space-y-6">
            {experiences.map((exp, idx) => (
              <motion.div
                ...
                className="bg-white rounded-2xl p-6 shadow-xl border-2 border-gray-200 relative overflow-hidden group"
                style={{
                  transform: `perspective(1000px) rotateY(${idx % 2 === 0 ? '-2' : '2'}deg)`
                }}
              >
                {/* Corner accent */}
                <motion.div
                  ...
                  className="absolute top-0 right-0 w-20 h-20 bg-gray-900 opacity-5 rounded-bl-full"
                />
                ...
                <div className="relative z-10">
                  ...
                  {/* Description */}
                  <p className="text-sm text-gray-700 mb-3 pl-4 border-l-2 border-gray-900 italic">
                    {exp.description}
                  </p>
                  ...
                  {exp.responsibilities && (
                    <ul className="space-y-1 mb-3">
                      {exp.responsibilities.map((resp, i) => (
                        ...
                        >
                          <ChevronRight size={12} className="mt-0.5 flex-shrink-0 text-gray-900" />
                          <span>{resp}</span>
                        </motion.li>
                      ))}
                    </ul>
                  ...
                  <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                    {exp.tech.map((t, i) => (
                      <motion.span
                        ...
                        className="px-3 py-1 bg-gray-900 text-white text-xs rounded-lg font-medium whitespace-nowrap shadow-md hover:shadow-lg transition-shadow"
                      >
                        {t}
                      </motion.span>
                    ))}
