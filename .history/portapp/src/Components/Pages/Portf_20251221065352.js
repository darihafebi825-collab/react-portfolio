...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-24 bg-white relative overflow-hidden">
      {/* Circuit board / Tech pattern background */}
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          className="absolute top-20 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent opacity-30"
        />
        <motion.div
          initial={{ x: '100%' }}
          animate={{ x: '-100%' }}
          transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
          className="absolute top-40 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent opacity-30"
        />
        ...
        <motion.div
          ...
          animate={{ y: '100%' }}
          transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
          className="absolute top-0 bottom-0 left-1/4 w-px bg-gradient-to-b from-transparent via-gray-300 to-transparent opacity-20"
        />
        <motion.div
          initial={{ y: '100%' }}
          animate={{ y: '-100%' }}
          transition={{ duration: 28, repeat: Infinity, ease: "linear" }}
          className="absolute top-0 bottom-0 right-1/4 w-px bg-gradient-to-b from-transparent via-gray-300 to-transparent opacity-20"
        />
        
        <div className="absolute top-0 left-0 w-32 h-32 border-t-2 border-l-2 border-gray-200 opacity-30" />
        <div className="absolute top-0 right-0 w-32 h-32 border-t-2 border-r-2 border-gray-200 opacity-30" />
        <div className="absolute bottom-0 left-0 w-32 h-32 border-b-2 border-l-2 border-gray-200 opacity-30" />
        <div className="absolute bottom-0 right-0 w-32 h-32 border-b-2 border-r-2 border-gray-200 opacity-30" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            <div className="bg-gray-900 p-5 rounded-2xl shadow-2xl relative">
          ...
          <motion.div 
            ...
            className="h-1 bg-gray-900 mx-auto mb-4"
          />
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            My professional path from Trivandrum to Bangalore
          </p>
        </motion.div>
        ...
        <div className="relative">
          ...
          <div className="absolute top-32 left-0 right-0 h-1 hidden md:block">
            <motion.div
              initial={{ width: 0 }}
              whileInView={{ width: '100%' }}
              transition={{ duration: 2, ease: "easeInOut" }}
              className="h-full bg-gradient-to-r from-gray-900 via-gray-600 to-gray-900 rounded-full"
            />
          </div>
          
          {/* Journey cards in horizontal scroll */}
          <div className="flex gap-8 overflow-x-auto pb-8 scrollbar-hide">
            {experiences.map((exp, idx) => (
              <div key={idx} className="relative flex-shrink-0 pt-16">
                {/* Journey node */}
                <motion.div
                  initial={{ scale: 0, y: 20 }}
                  whileInView={{ scale: 1, y: 0 }}
                  transition={{ delay: idx * 0.3, type: "spring", stiffness: 200 }}
                  className="absolute top-28 left-1/2 transform -translate-x-1/2 z-20"
                >
                  <div className="relative">
                    <motion.div
                      animate={{ 
                      ...
                      className="absolute inset-0 -m-3 bg-gray-900 rounded-full"
                    />
                    <div className="relative w-8 h-8 bg-gray-900 rounded-full border-4 border-white shadow-xl flex items-center justify-center">
                ...
                {idx < experiences.length - 1 && (
                  <motion.div
                    ...
                    className="absolute top-32 right-0 transform translate-x-1/2 z-10 hidden md:block"
                  >
                ...
                <motion.div
                  ...
                  className="w-[380px] bg-white rounded-2xl p-6 shadow-xl border-2 border-gray-200 relative overflow-hidden group"
                >
                  {/* Step number badge */}
                  <motion.div
                    initial={{ scale: 0, rotate: -180 }}
                    ...
                    className="absolute top-4 right-4 w-10 h-10 bg-gray-900 text-white rounded-full flex items-center justify-center font-bold text-lg shadow-lg"
                  >
                    {idx + 1}
                  </motion.div>
                  ...
                  <motion.div
                    initial={{ width: 0, height: 0 }}
                    whileInView={{ width: 50, height: 50 }}
                    transition={{ delay: idx * 0.3 + 0.3 }}
                    className="absolute bottom-0 left-0 border-b-4 border-l-4 border-gray-900 rounded-tl-2xl"
                  />
                  ...
                  <div className="relative z-10 pt-2">
                    ...
                    <div className="flex items-start gap-3 mb-4">
                      <motion.div
                        whileHover={{ rotate: 360 }}
                        transition={{ duration: 0.6 }}
                        className="bg-gray-900 p-3 rounded-xl shadow-lg flex-shrink-0"
                      >
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className="flex items-center gap-1.5 bg-gray-100 px-3 py-1.5 rounded-lg text-sm font-medium border border-gray-200">
                        <Calendar size={14} className="text-gray-900" />
                        {exp.period}
                      </span>
                      <span className="flex items-center gap-1.5 bg-gray-900 text-white px-3 py-1.5 rounded-lg text-sm font-medium">
                        <MapPin size={14} />
                        {exp.location}
                      </span>
                    </div>
                      ...
                      <ul className="space-y-1.5 mb-4">
                        {exp.responsibilities.map((resp, i) => (
                          <motion.li
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            transition={{ delay: idx * 0.3 + 0.1 * i }}
                    ...
                    <div className="flex flex-wrap gap-2">
                      {exp.tech.slice(0, 6).map((t, i) => (
                        <motion.span
                          ...
                          transition={{ delay: idx * 0.3 + 0.05 * i, type: "spring" }}
                          whileHover={{ scale: 1.1, y: -2 }}
                          className="px-2.5 py-1 bg-gray-900 text-white text-xs rounded-lg font-medium shadow-md hover:shadow-lg transition-shadow"
                        >
                          {t}
                        </motion.span>
                      ))}
            ...
            <motion.div
              ...
              className="flex-shrink-0 w-[200px] pt-16"
            >
              <div className="h-full flex flex-col items-center justify-center text-center">
                <motion.div
                  ...
                  className="w-20 h-20 bg-gradient-to-br from-gray-900 to-gray-600 rounded-full flex items-center justify-center mb-4 shadow-2xl"
                >
                  <span className="text-4xl">🚀</span>
                </motion.div>
                <h4 className="text-xl font-bold text-gray-900 mb-2">What's Next?</h4>
                <p className="text-sm text-gray-600">Exciting opportunities ahead!</p>
              </div>
            </motion.div>
          </div>
          ...
          <motion.div
            ...
            className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 md:hidden"
          >
