    ...
    <section id="experience" className="py-24 bg-gradient-to-b from-gray-100 to-gray-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            <div className="relative" style={{
              ...
              <div className="absolute inset-0 bg-gray-900 rounded-2xl blur-xl opacity-50" style={{
          ...
          <motion.div 
            ...
            className="h-1.5 bg-gray-900 mx-auto mb-4 rounded-full"
          />
          <p className="text-gray-700 max-w-2xl mx-auto text-lg font-medium">
            A 3D journey through my professional experience
          </p>
        </motion.div>
        ...
        <div className="relative" style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8" style={{
            transformStyle: 'preserve-3d'
          }}>
            {experiences.map((exp, idx) => (
              <motion.div
                ...
                style={{
                  transformStyle: 'preserve-3d',
                  transform: `translateZ(${idx * 30}px) rotateY(${idx % 2 === 0 ? '5' : '-5'}deg)`
                }}
              >
                {/* Platform base - 3D floor */}
                <motion.div
                  whileHover={{ 
                    y: -20,
                    rotateX: -5,
