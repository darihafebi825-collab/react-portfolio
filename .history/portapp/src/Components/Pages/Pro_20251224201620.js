        ...
        <div className="flex gap-6 overflow-x-auto scrollbar-hide py-4">
          {projects.map((project, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="w-[340px] flex-shrink-0 bg-[#eef1f5] rounded-2xl shadow-[12px_12px_24px_#cfd3d8,-12px_-12px_24px_#ffffff] border border-gray-200 overflow-hidden flex flex-col transition-shadow"
            >
              {/* Project image / emoji */}
              <div className="h-48 flex items-center justify-center text-6xl bg-gradient-to-br from-gray-200 to-gray-300">
                {project.image}
              </div>

              <div className="p-6 flex flex-col flex-grow">
                <span className="text-sm text-gray-900 uppercase tracking-wider mb-2 font-semibold">
                  {project.category}
                </span>
