...
const Hero = () => {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="min-h-screen flex items-center justify-center pt-16 bg-gray-50"
    >
      <motion.div style={{ y, opacity }} className="text-center px-6">
        ...
        <h1 className="text-5xl font-bold mb-4">
          Hi, I'm <span className="text-gray-700">Dariha Suresh</span>
        </h1>
        ...
        <div className="flex justify-center gap-4">
          <button
            ...
            className="px-6 py-3 bg-gray-900 text-white rounded-full flex items-center gap-2"
          >
            Let's Connect <Send size={18} />
          </button>
          ...
          <button
            ...
            className="px-6 py-3 border border-gray-900 rounded-full flex items-center gap-2"
          >
            View Projects <ChevronRight size={18} />
          </button>
        </div>
    ...
    <footer className="bg-gray-900 text-white py-10">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <p className="text-gray-400 mb-4">
          © 2025 Dariha Suresh. All rights reserved.
        </p>
        <button
