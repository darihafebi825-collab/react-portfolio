...
const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      tech: ['Python', 'TensorFlow', 'Keras', 'PyTorch', 'OpenCV', 'NumPy', 'Pandas', 'Scikit-learn']
    },
    {
      title: 'Web Developer',
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex items-center justify-between mb-20">
          <motion.div
            ...
            className="bg-gradient-to-br from-emerald-500 via-cyan-500 to-violet-500 p-6 rounded-2xl shadow-2xl"
          >
          ...
          >
            ...
            <motion.div
              ...
              className="h-1.5 bg-gradient-to-r from-emerald-500 via-cyan-500 to-violet-500 ml-auto mb-4 rounded-full"
            />
            <p className="text-gray-600 max-w-xs ml-auto text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          {experiences.map((exp, idx) => (
            ...
            >
              <div className="relative bg-white rounded-xl p-6 shadow-xl border border-gray-200 overflow-hidden">

                {/* Index badge */}
                <div className="absolute -top-4 -right-4 w-16 h-16 rounded-full bg-gradient-to-br from-emerald-500 via-cyan-500 to-violet-500 flex items-center justify-center font-bold text-2xl text-white shadow-xl">
                  {idx + 1}
                </div>
                ...
                <div className="pt-2">
                  <div className="flex items-start gap-3 mb-4">
                    <div className="bg-gradient-to-br from-emerald-500 via-cyan-500 to-violet-500 p-3 rounded-xl shadow-lg">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="flex items-center gap-1.5 bg-emerald-50 text-emerald-700 px-3 py-1.5 rounded-lg text-xs font-medium">
                      <Calendar size={12} />
                      {exp.period}
                    </span>
                    <span className="flex items-center gap-1.5 bg-violet-50 text-violet-700 px-3 py-1.5 rounded-lg text-xs font-medium">
                      <MapPin size={12} />
                      {exp.location}
                    </span>
                  </div>

                  <p className="text-sm text-gray-700 mb-3 pl-3 border-l-2 border-cyan-500 italic leading-relaxed">
                    {exp.description}
                  </p>
                    ...
                    <ul className="space-y-1.5 mb-4">
                      {exp.responsibilities.map((resp, i) => (
                        <li key={i} className="text-xs text-gray-700 flex gap-2">
                          <ChevronRight size={14} className="text-cyan-600 mt-0.5" />
                          {resp}
                        </li>
                      ))}
                    </ul>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.tech.slice(0, 5).map((t, i) => (
                      <span
                        key={i}
                        className="px-2.5 py-1 bg-gradient-to-r from-emerald-500 via-cyan-500 to-violet-500 text-white text-xs rounded-lg font-medium shadow-md"
                      >
                        {t}
                      </span>
                    ))}
