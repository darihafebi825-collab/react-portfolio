      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-16 items-center">
        ...
        <motion.div
          ...
          className="
            ...
            bg-[#eef1f5] rounded-full p-10
            shadow-[12px_12px_24px_#cfd3d8,-12px_-12px_24px_#ffffff]
          "
        >
          <div className="w-[3px] h-32 bg-gradient-to-b from-gray-300 to-gray-600 rounded-full"></div>
          <ArrowDown className="mt-3 text-gray-600" size={24} />
        </motion.div>
