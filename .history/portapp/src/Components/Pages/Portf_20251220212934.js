...
const Projects = () => {
  ...
  <motion.a whileHover={{ scale: 1.05 }} href="#"
    className="flex-1 text-center px-3 py-2 bg-gray-900 text-white rounded-lg text-sm font-medium">
    <Github size={16} /> Code
  </motion.a>
  <motion.a whileHover={{ scale: 1.05 }} href="#"
    className="flex-1 text-center px-3 py-2 bg-white border-2 border-gray-900 text-gray-900 rounded-lg text-sm font-medium">
    <ExternalLink size={16} /> Demo
  </motion.a>
</div>
