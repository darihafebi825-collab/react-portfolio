...
const Exp = () => {
  return (
    <section className="min-h-screen bg-gray-50 relative py-20 px-6 overflow-hidden">
      ...
      {/* 3D Background Card with Graphic Illusion */}
      <div className="absolute inset-0 flex justify-center items-center -z-10">
        <div className="relative w-[95%] h-[90%] bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.2),0_10px_20px_rgba(0,0,0,0.1)] overflow-hidden">
          
          {/* Diagonal Border Lines */}
          <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
            <div className="absolute top-0 left-0 w-full h-full border-t border-l border-gray-200 rotate-[15deg] origin-top-left"></div>
            <div className="absolute top-0 left-0 w-full h-full border-b border-r border-gray-200 rotate-[-15deg] origin-bottom-right"></div>
          </div>

          {/* Subtle Gradient Overlay for Illusion */}
