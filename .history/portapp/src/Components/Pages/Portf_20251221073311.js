...
import { Briefcase, Code2, Calendar, MapPin, ChevronRight, ArrowRight } from 'lucide-react';
...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-24 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-96 h-96 bg-blue-500/10 rounded-full blur-3xl -top-48 -left-48 animate-pulse" />
        <div className="absolute w-96 h-96 bg-purple-500/10 rounded-full blur-3xl top-1/2 right-0 animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute w-96 h-96 bg-green-500/10 rounded-full blur-3xl -bottom-48 left-1/3 animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="h-1.5 bg-gradient-to-r from-blue-500 via-purple-500 to-green-500 mx-auto mb-4 rounded-full"
          />
        ...
        <div className="relative">
          ...
          <motion.div 
            ...
            className="hidden md:block absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-blue-500 via-purple-500 to-green-500 rounded-full"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            {experiences.map((exp, idx) => (
              <motion.div
                ...
                className={`relative ${idx % 2 === 0 ? 'md:-mt-32' : 'md:mt-32'}`}
              >
                {/* Timeline Dot */}
                <motion.div
                  initial={{ scale: 0 }}
                  ...
                  className={`hidden md:block absolute ${idx % 2 === 0 ? 'bottom-0 mb-[-2rem]' : 'top-0 mt-[-2rem]'} left-1/2 transform -translate-x-1/2 w-8 h-8 bg-gradient-to-br ${exp.color} rounded-full border-4 border-slate-900 z-20 shadow-xl`}
                >
                  <div className="absolute inset-0 rounded-full bg-white/30 animate-ping" />
                </motion.div>
                
                {/* Connecting Line */}
                <div className={`hidden md:block absolute ${idx % 2 === 0 ? 'bottom-0 mb-[-2rem]' : 'top-0 mt-[-2rem]'} left-1/2 transform -translate-x-1/2 w-0.5 ${idx % 2 === 0 ? 'h-8 bg-gradient-to-b' : 'h-8 bg-gradient-to-t'} ${exp.color}`} />
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur-xl p-6 rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
                    {/* Gradient overlay */}
                    ...
                    <motion.div
                      ...
                      className={`absolute -top-4 -right-4 w-14 h-14 bg-gradient-to-br ${exp.color} rounded-full flex items-center justify-center font-bold text-xl text-white shadow-xl border-4 border-slate-900 z-10`}
                    >
                      {idx + 1}
                    </motion.div>
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 0.6 }}
                      className={`inline-flex bg-gradient-to-br ${exp.color} p-3 rounded-xl shadow-lg mb-4`}
                    >
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className="flex items-center gap-1.5 bg-slate-700/50 backdrop-blur text-slate-200 px-3 py-1.5 rounded-lg text-xs font-medium border border-slate-600">
                        <Calendar size={12} />
                        {exp.period}
                      </span>
                    ...
                    {/* Description */}
                    <p className="text-sm text-slate-300 mb-4 pl-3 border-l-2 border-white/20 italic">
                      {exp.description}
                    </p>
                    ...
                    {exp.responsibilities && (
                      <ul className="space-y-2 mb-4">
                        {exp.responsibilities.map((resp, i) => (
                          ...
                          >
                            <ChevronRight size={14} className="mt-0.5 flex-shrink-0 text-white/70" />
                            <span>{resp}</span>
                          </motion.li>
                        ))}
                      </ul>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {exp.tech.slice(0, 4).map((t, i) => (
                        <motion.span
                          ...
                          className="px-2.5 py-1 bg-white/10 backdrop-blur text-white text-xs rounded-lg font-medium border border-white/20 hover:bg-white/20 transition-colors"
                        >
                          {t}
                        </motion.span>
                      ))}
