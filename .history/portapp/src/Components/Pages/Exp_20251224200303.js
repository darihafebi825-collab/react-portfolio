  ...
  return (
    <section className="min-h-screen bg-[#eef1f5] py-20 px-6">
      <div className="max-w-4xl mx-auto relative">
        ...
        {/* BIG TITLE LEFT-END NEUMORPHIC BOX */}
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="mb-16 px-10 py-6 flex items-center justify-between rounded-2xl bg-[#eef1f5] shadow-[12px_12px_24px_#cfd3d8,-12px_-12px_24px_#ffffff]"
        ...
        >
          ...
          {/* Icon inside the same box on the right */}
          <motion.div
            whileTap={{
              scale: 0.85,
              boxShadow:
        ...
        <div className="absolute left-1/2 top-32 bottom-16 w-1 bg-gray-300 -translate-x-1/2 rounded-full"></div>
        ...
        <div className="space-y-8">
          {experiences.map((exp, idx) => (
            ...
            >
              ...
              <motion.div
                onClick={() =>
                  setPressedCard(idx === pressedCard ? null : idx)
                }
                animate={{
                  boxShadow:
                    pressedCard === idx
          ...
          >
            ...
            {/* Fallen board */}
            <motion.div
              whileHover={{ rotate: -1, y: -3, scale: 1.02 }}
              className="
                px-10 py-3
