          ...
          {skillCategories.map((category, idx) => {
            ...
            return (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-[200px] h-[200px] bg-[#1a1f2e] border-2 border-[#1a1f2e] rounded-2xl p-6 flex flex-col items-center justify-center gap-4 shadow-xl hover:border-gray-500 relative overflow-hidden"
              >
                <motion.div
