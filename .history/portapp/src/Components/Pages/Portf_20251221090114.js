      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 relative">
          {experiences.map((exp, idx) => (
            ...
            >
              <div className="relative bg-gradient-to-b from-white to-gray-50 rounded-xl p-6 shadow-lg border border-gray-200 overflow-hidden group">
                {/* Step Indicator */}
                <div className="absolute -top-4 -right-4 w-16 h-16 bg-gray-400 rounded-full flex items-center justify-center font-bold text-2xl text-gray-800 shadow-md border-4 border-gray-200">
                  {idx + 1}
                </div>

                <div className="relative z-10 pt-2">
                  <div className="flex items-start gap-3 mb-4">
                    <div className="bg-gray-200 p-3 rounded-xl shadow-sm">
                      <Code2 size={24} className="text-gray-800" />
                    </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    <span className="flex items-center gap-1.5 bg-gray-300 text-gray-800 px-3 py-1.5 rounded-lg text-xs font-medium shadow-sm">
                      <MapPin size={12} />
                      {exp.location}
                    </span>
                  </div>

                  <p className="text-sm text-gray-700 mb-3 pl-3 border-l-2 border-gray-400 italic leading-relaxed">
                    {exp.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.tech.slice(0, 5).map((t, i) => (
                      <span key={i} className="px-2.5 py-1 bg-gray-300 text-gray-800 text-xs rounded-lg font-medium shadow-sm">
                        {t}
                      </span>
                    ))}
                    {exp.tech.length > 5 && (
