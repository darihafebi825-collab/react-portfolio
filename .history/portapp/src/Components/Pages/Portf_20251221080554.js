...
const Experience = () => {
  const experiences = [
    {
      ...
      tech: ['React JS', 'JavaScript', 'HTML5', 'CSS3', 'Tailwind'],
    },
    {
      ...
      period: 'Mar – Jun 2025',
      location: 'Technopark, Trivandrum',
      description: 'Worked on training and testing models for yoga pose recognition.',
    ...
    },
    {
      ...
      location: 'Bangalore',
      description: 'Contributed to multiple client-facing web applications.',
      tech: ['React', 'MySQL'],
    },
  ];
  ...
  return (
    <section className="relative py-32 bg-gray-50 overflow-hidden">
      ...
      {/* Newspaper scribble background */}
      <div className="absolute inset-0">
        <div className="w-full h-full bg-[url('/newspaper-scribble.png')] bg-repeat opacity-10"></div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-600 italic text-lg">
            A magazine-style journey through my career
          </p>
        </motion.div>

        {/* Experiences as “articles” */}
        <div className="grid md:grid-cols-3 gap-12">
          {experiences.map((exp, idx) => (
            <motion.div
              ...
              className="relative group border-l-4 border-gray-900 pl-6 py-6 hover:shadow-2xl transition-shadow duration-300 bg-white/90 backdrop-blur-sm rounded-xl"
            >
              {/* Decorative headline number */}
              <span className="absolute -top-6 -left-10 text-6xl font-serif font-bold text-gray-200 opacity-30">
                {idx + 1}
              </span>
              ...
              {/* Company & period */}
              <div className="flex flex-col sm:flex-row sm:justify-between text-gray-700 text-sm mb-3">
              ...
              {/* Description */}
              <p className="text-gray-700 text-sm mb-4 italic border-l-2 border-gray-300 pl-3">
                {exp.description}
              </p>
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {exp.tech.map((t, i) => (
                  <span
                    key={i}
                    className="text-xs font-medium px-2 py-1 border border-gray-900 rounded-sm"
                  >
                    {t}
                  </span>
                ))}
        ...
        >
          <div className="mx-auto w-48 h-48 bg-[url('/adventure-illustration.svg')] bg-contain bg-no-repeat"></div>
          <h2 className="mt-6 text-5xl font-bold font-serif text-gray-900">
            Adventure Awaits
          </h2>
