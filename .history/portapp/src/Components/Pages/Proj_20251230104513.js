...
function ThreeDImageRing({
  ...
  return (
    ...
    >
      ...
      >
        <motion.div ref={ringRef} style={{ transformStyle: "preserve-3d", rotateY: rotationY }}>
          <AnimatePresence>
            {projects.map((p, i) => (
              <motion.div
                key={i}
                ...
                transition={{ delay: i * staggerDelay, duration: animationDuration, ease: easeOut }}
  ...
  const sampleProjects = [
    {
      ...
      description: "Responsive restaurant frontend website with modern UI",
      tags: ["HTML", "CSS", "JavaScript"],
      image: "https://images.unsplash.com/photo-1600891964599-f61ba0e24092?w=600",
    },
    {
      title: "AI-Powered Yoga Pose Detection",
      description: "Computer vision-based yoga pose detection system",
      tags: ["Python", "OpenCV", "ML"],
      image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600",
    },
    {
      title: "React Code Debugger",
      description: "Interactive debugging tool built with React",
  ...
  return (
    <div className="w-screen h-screen bg-white relative">
      ...
      <div className="absolute top-8 left-1/2 -translate-x-1/2 text-center z-10">
        ...
        >
          🔗 github.com/darihafebi825-collab
        </a>
      </div>
