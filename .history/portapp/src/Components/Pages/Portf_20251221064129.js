...
const About = () => {
  return (
    <section id="about" className="py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-gray-900 opacity-5 rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gray-900 opacity-5 rounded-full blur-3xl" />
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            {/* Left side - Text content with accent line */}
            <div className="relative p-12 border-l-8 border-gray-900">
              {/* Decorative corner element */}
              <div className="absolute top-0 left-0 w-20 h-20 border-t-4 border-l-4 border-gray-900 opacity-20" />
              
              <div className="space-y-6">
                <div>
                  <div className="inline-block px-4 py-1 bg-gray-900 text-white text-sm font-semibold rounded-full mb-4">
                    👋 Hello, I'm
                  </div>
                  <h3 className="text-4xl font-bold text-gray-900 mb-2 tracking-tight">Dariha</h3>
                  <p className="text-gray-600 text-xl mb-6 font-medium">Full Stack Developer</p>
                  <div className="w-16 h-1 bg-gradient-to-r from-gray-900 to-gray-600 mb-6" />
                </div>
                
                <p className="text-gray-700 leading-relaxed text-lg border-l-4 border-gray-200 pl-4">
                  I'm a passionate fresher who has completed <span className="font-semibold text-gray-900">11+ academic projects</span> across
                ...
                <p className="text-gray-700 leading-relaxed text-lg">
                  I enjoy combining <span className="font-semibold text-gray-900">clean code</span> with unique <span className="font-semibold text-gray-900">UI/UX design</span> to create impactful
                  and user-focused digital solutions. I specialize in full-stack development with expertise in React and modern web technologies.
                </p>
                
                {/* Small decorative element */}
                <div className="flex items-center gap-2 text-sm text-gray-500 italic pt-4">
                  <Code2 size={16} />
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-12 flex items-center justify-center relative">
              ...
              <div className="grid grid-cols-2 gap-5 w-full relative z-10">
                {[
                  { icon: Briefcase, label: 'Fresher', desc: 'Experience', color: 'from-blue-500 to-blue-600' },
                  { icon: Award, label: '11+ Projects', desc: 'Completed', color: 'from-green-500 to-green-600' },
                  { icon: Star, label: 'Growing', desc: 'Portfolio', color: 'from-purple-500 to-purple-600' },
                  { icon: Code2, label: '10+ Tech', desc: 'Stacks', color: 'from-orange-500 to-orange-600' }
                ].map((stat, idx) => (
                  <motion.div 
                    key={idx} 
                    ...
                    className="bg-white p-6 rounded-2xl text-center shadow-lg border-2 border-gray-200 hover:border-gray-900 transition-all duration-300 relative overflow-hidden group"
                  >
                    {/* Hover gradient overlay */}
                    <div className={`absolute inset-0 bg-gradient-to-br ${stat.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300`} />
                    
                    <div className="relative z-10">
                      <div className="bg-gray-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:bg-gray-900 transition-colors duration-300">
                        <stat.icon className="text-gray-900 group-hover:text-white transition-colors duration-300" size={28} />
                      </div>
          ...
          <div className="h-1 bg-gradient-to-r from-transparent via-gray-900 to-transparent" />
        </motion.div>
      </div>
    </section>
  );
