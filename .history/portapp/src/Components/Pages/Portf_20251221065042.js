    ...
    <section id="experience" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          className="absolute bottom-40 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent opacity-30"
        />
        ...
        {/* Circuit nodes */}
        <div className="absolute top-32 left-1/4 w-3 h-3 bg-gray-900 rounded-full opacity-20" />
        <div className="absolute top-48 right-1/3 w-2 h-2 bg-gray-900 rounded-full opacity-20" />
        <div className="absolute bottom-32 left-1/3 w-3 h-3 bg-gray-900 rounded-full opacity-20" />
        <div className="absolute bottom-48 right-1/4 w-2 h-2 bg-gray-900 rounded-full opacity-20" />
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-1 hidden md:block overflow-hidden rounded-full">
            <motion.div
              initial={{ height: 0 }}
              whileInView={{ height: '100%' }}
              transition={{ duration: 1.5, ease: "easeInOut" }}
              className="absolute inset-0 bg-gradient-to-b from-gray-900 via-gray-700 to-gray-900"
            />
          </div>
              ...
              <div className={`flex flex-col md:flex-row gap-8 items-start ${idx % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                <div className="md:w-1/2 md:pr-12">
                  <motion.div 
                    ...
                    className="bg-white p-8 rounded-2xl shadow-xl border-2 border-gray-200 relative overflow-hidden group"
                  >
                    {/* Animated corner accents */}
                    <motion.div
                      initial={{ width: 0, height: 0 }}
                      whileInView={{ width: 40, height: 40 }}
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        <motion.div
                          ...
                          transition={{ duration: 0.6 }}
                          className="bg-gradient-to-br from-gray-900 to-gray-700 p-3 rounded-xl shadow-lg flex-shrink-0"
                        >
                      ...
                      <div className="mb-4 pl-4 border-l-4 border-gray-900">
                        <p className="text-gray-700 italic leading-relaxed">{exp.description}</p>
                      </div>
                      
                      {/* Responsibilities with animated bullets */}
                        ...
                        <ul className="space-y-2 mb-5">
                          {exp.responsibilities.map((resp, i) => (
                            <motion.li 
                              ...
                              whileHover={{ x: 5 }}
                              className="text-sm text-gray-700 flex items-start gap-2 group/item"
                            >
                              <span className="mt-1 p-1 bg-gray-900 rounded-full flex-shrink-0">
                                <ChevronRight size={12} className="text-white" />
                              </span>
                              <span className="group-hover/item:text-gray-900 transition-colors">{resp}</span>
                            </motion.li>
                          ))}
                        </ul>
                      )}
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.tech.map((t, i) => (
                          <motion.span 
                            ...
                            className="px-3 py-1.5 bg-gray-900 text-white text-xs rounded-lg font-medium shadow-md hover:shadow-lg transition-shadow cursor-default"
                          >
                            {t}
                          </motion.span>
                        ))}
                ...
                <motion.div 
                  ...
                  className="absolute left-8 md:left-1/2 transform -translate-x-1/2 mt-8 hidden md:block"
                >
                  <div className="relative">
                    {/* Pulsing ring */}
                    <motion.div
                      ...
                      className="absolute inset-0 -m-2 bg-gray-900 rounded-full opacity-30"
                    />
                    {/* Main dot */}
                    <div className="relative w-6 h-6 bg-gradient-to-br from-gray-900 to-gray-700 rounded-full border-4 border-white shadow-xl" />
                  </div>
                </motion.div>
              </div>
            </motion.div>
