      ...
      <div className="flex gap-6 overflow-x-auto scrollbar-hide py-4">
        {projects.map((project, idx) => (
          <motion.div
            ...
            whileHover={{ y: -8 }}
            className="min-w-[320px] flex-shrink-0 bg-white rounded-xl border border-gray-200 shadow-md hover:shadow-xl transition-all duration-300 h-full flex flex-col"
          >
            <div className="h-40 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 flex items-center justify-center text-6xl rounded-t-xl">
              {project.image}
            </div>

            <div className="p-6 flex flex-col flex-grow">
              <div className="text-xs text-blue-600 uppercase tracking-wider mb-2 font-semibold">
                {project.category}
              </div>
              ...
              <div className="flex gap-3 mt-auto">
                <motion.a
                  ...
                  href="#"
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-blue-900 text-white rounded-lg text-sm font-medium"
                >
                  <Github size={16} /> Code
                </motion.a>
                ...
                <motion.a
                  whileHover={{ scale: 1.05 }}
                  href="#"
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2 border-2 border-blue-900 text-blue-900 rounded-lg text-sm font-medium"
                >
