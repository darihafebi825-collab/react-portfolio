              ...
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: hoveredIndex === index 
                    ? "0 25px 50px rgba(0, 0, 0, 0.6), 0 0 30px rgba(255, 255, 255, 0.3)" 
...
export default function App() {
  ...
  return (
    <div className="w-screen h-screen bg-white relative" style={{
      backgroundImage: `
      ...
      <div className="absolute top-8 left-1/2 transform -translate-x-1/2 text-center z-10">
        <h1 className="text-5xl font-bold text-gray-900 mb-2 tracking-tight drop-shadow-lg">Project Showcase</h1>
        <p className="text-gray-800 text-lg drop-shadow">Drag to explore • Hover for details</p>
      </div>
