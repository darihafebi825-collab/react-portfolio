...
const Experience = () => {
  ...
  return (
    <section className="relative min-h-screen bg-black overflow-hidden py-32">
      ...
      {/* Animated map grid */}
      <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.08)_1px,transparent_1px)] bg-[size:40px_40px]" />
      ...
      <div className="relative z-10 text-center mb-20">
        ...
        <p className="text-gray-400 mt-4">
          Real-world locations of my professional journey
        </p>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto h-[600px]">
        ...
        <svg className="absolute inset-0 w-full h-full">
          <line x1="15%" y1="35%" x2="50%" y2="60%" stroke="rgba(255,255,255,0.2)" strokeWidth="2" />
          <line x1="50%" y1="60%" x2="80%" y2="30%" stroke="rgba(255,255,255,0.2)" strokeWidth="2" />
        </svg>
        ...
        {experiences.map((exp, idx) => (
          ...
          >
            {/* Pin */}
            <motion.div
              animate={{ boxShadow: ['0 0 0px', '0 0 40px'] }}
              transition={{ duration: 2, repeat: Infinity }}
              className={`w-14 h-14 rounded-full bg-gradient-to-br ${exp.color} flex items-center justify-center text-white font-bold`}
            >
              {idx + 1}
            </motion.div>
            ...
            <motion.div
              ...
              className="mt-6 w-72 bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-4 text-white shadow-2xl"
            >
