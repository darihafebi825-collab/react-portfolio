    ...
    <section id="experience" className="py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute bottom-10 right-10 w-96 h-96 bg-purple-500 rounded-full opacity-10 blur-3xl"
        />
        <motion.div
          animate={{
            y: [0, -20, 0],
          ...
          className="absolute top-1/2 left-1/3 w-64 h-64 bg-green-500 rounded-full opacity-10 blur-3xl"
        />
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="h-1 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 mx-auto mb-4"
          />
        ...
        <div className="relative">
          ...
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-1 hidden md:block overflow-hidden">
              ...
              <div className={`flex flex-col md:flex-row gap-8 items-start ${idx % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                <div className="md:w-1/2 md:pr-12">
                  <motion.div 
                    ...
                    className="bg-white p-8 rounded-2xl shadow-2xl border-2 border-gray-200 relative overflow-hidden group"
                  >
                    {/* Gradient overlay on hover */}
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-purple-500/5 to-pink-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    
                    {/* Corner accents */}
                    <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-500 opacity-10 rounded-bl-full" />
                    <div className="absolute bottom-0 left-0 w-20 h-20 bg-gradient-to-tr from-pink-500 to-purple-500 opacity-10 rounded-tr-full" />
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        <motion.div
                          whileHover={{ rotate: 360 }}
                          transition={{ duration: 0.6 }}
                          className="bg-gradient-to-br from-gray-900 to-gray-700 p-3 rounded-xl shadow-lg"
                        >
                          <Code2 size={24} className="text-white" />
                        </motion.div>
                        
                        <div className="flex-1">
                          <h3 className="text-2xl font-bold text-gray-900 mb-1 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300">
                            {exp.title}
                          </h3>
                      ...
                      {/* Description */}
                      <div className="mb-4 pl-1 border-l-4 border-gradient-to-b from-blue-500 to-purple-500">
                        <p className="text-gray-700 pl-3 italic leading-relaxed">{exp.description}</p>
                      </div>
                      ...
                      {exp.responsibilities && (
                        <ul className="space-y-2 mb-5">
                          {exp.responsibilities.map((resp, i) => (
                            ...
                            >
                              <span className="mt-1 p-1 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.tech.map((t, i) => (
                          <motion.span 
                            ...
                            className="px-3 py-1.5 bg-gradient-to-r from-gray-900 to-gray-700 text-white text-xs rounded-lg font-medium shadow-md hover:shadow-lg transition-shadow cursor-default"
                          >
                            {t}
                          </motion.span>
                        ))}
                ...
                >
                  <div className="relative">
                    ...
                    />
                    <div className="relative w-6 h-6 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full border-4 border-white shadow-xl" />
                  </div>
                </motion.div>
              </div>
            </motion.div>
