        ...
        <div className="flex gap-3 overflow-x-auto scrollbar-hide py-4">
          {projects.map((project, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="w-[200px] flex-shrink-0 bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow flex flex-col"
            >
              <div className="h-24 bg-gradient-to-br from-gray-900 to-gray-700 flex items-center justify-center text-4xl">
                {project.image}
              </div>
              ...
              <div className="p-3 flex flex-col flex-grow">
                ...
                <div className="mb-2">
                  <div className="text-xs text-gray-900 uppercase tracking-wider mb-1 font-semibold">Key Features</div>
                  <div className="grid grid-cols-1 gap-0.5">
                    {project.features.slice(0, 3).map((feature, i) => (
                      <div key={i} className="text-xs text-gray-700 flex items-center gap-1">
                        <Star size={8} className="text-gray-900 flex-shrink-0" /> 
                ...
                <div className="flex flex-wrap gap-1 mb-2">
                  {project.tech.slice(0, 3).map((t, i) => (
                    <span key={i} className="px-1.5 py-0.5 bg-gray-100 text-gray-900 text-xs rounded font-medium">
                      {t}
                    </span>
                  ))}
                </div>
                ...
                <div className="flex gap-1.5 mt-auto">
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 flex items-center justify-center gap-1 px-2 py-1 bg-gray-900 text-white rounded text-xs font-medium">
                    <Github size={12} /> Code
                  </motion.a>
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 flex items-center justify-center gap-1 px-2 py-1 bg-white border-2 border-gray-900 text-gray-900 rounded text-xs font-medium">
