...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-24 bg-gray-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row md:items-start md:justify-between gap-12">
        ...
        <div className="flex-1 flex flex-col gap-8">
          {experiences.map((exp, idx) => (
            ...
            >
              <div className="relative bg-white rounded-xl p-6 shadow-xl border border-gray-200 overflow-hidden group">
                {/* Step indicator */}
                <div className="absolute -top-4 -right-4 w-16 h-16 bg-gray-900 rounded-full flex items-center justify-center font-bold text-2xl text-white shadow-xl border-4 border-white">
                  {idx + 1}
                </div>
                ...
                <div className="relative z-10 pt-2">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    <span className="flex items-center gap-1.5 bg-gray-900 text-white px-3 py-1.5 rounded-lg text-xs font-medium shadow-md">
                      <MapPin size={12} />
                      {exp.location}
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.tech.slice(0, 5).map((t, i) => (
                      <span key={i} className="px-2.5 py-1 bg-gray-900 text-white text-xs rounded-lg font-medium shadow-md">
                        {t}
                      </span>
                    ))}
                    {exp.tech.length > 5 && (
        ...
        <div className="flex-shrink-0 text-right md:text-right">
          ...
          >
            ...
            />
            <p className="text-gray-700 max-w-xs mx-auto md:ml-auto text-lg font-medium">
