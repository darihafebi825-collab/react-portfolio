...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-24 bg-gray-50 relative overflow-hidden">
      ...
      {/* Measurement marks on sides */}
      <div className="absolute left-0 top-0 bottom-0 w-8 flex flex-col justify-around px-1">
        {[...Array(20)].map((_, i) => (
          <div key={i} className="flex items-center gap-1">
            <div className="w-2 h-px bg-black/20" />
            <span className="text-[6px] text-black/30 font-mono">{i * 5}</span>
          </div>
        ))}
      </div>
      
      <div className="absolute right-0 top-0 bottom-0 w-8 flex flex-col justify-around px-1">
        {[...Array(20)].map((_, i) => (
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 relative">
        {/* Header with Technical Drawing Style */}
        <motion.div 
          initial={{ opacity: 0, y: 30 }} 
          whileInView={{ opacity: 1, y: 0 }} 
          viewport={{ once: true }} 
        ...
        >
          ...
          <div className="inline-block border-2 border-black p-8 bg-white relative">
            {/* Corner markers */}
            ...
            >
              <Briefcase size={48} className="text-black" strokeWidth={1.5} />
            </motion.div>
            
            <h2 className="text-5xl md:text-6xl font-bold text-black mb-2 tracking-tight" style={{ fontFamily: 'monospace' }}>
              EXPERIENCE
            </h2>
            <div className="flex items-center justify-center gap-4 text-sm font-mono text-black/60">
          ...
          {/* Connecting lines */}
          <svg className="absolute left-1/2 -translate-x-1/2 -bottom-10 w-1 h-10" style={{ overflow: 'visible' }}>
            <motion.line 
        ...
        {/* Experience Cards - Technical Document Style */}
        <div className="space-y-12">
          {experiences.map((exp, idx) => (
            <motion.div
              ...
              className="relative"
            >
              {/* Document paper with fold */}
              <div className="relative bg-white border-2 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                {/* Paper fold effect */}
                <div className="absolute top-0 right-0 w-16 h-16 bg-gray-100 border-l-2 border-b-2 border-black" style={{
                ...
                <motion.div
                  ...
                  className="absolute -top-6 -right-6 w-20 h-20 rounded-full border-4 border-black bg-white flex items-center justify-center font-bold text-3xl shadow-lg"
                ...
                {/* Punch holes */}
                <div className="absolute -left-1 top-1/4 w-3 h-3 rounded-full bg-gray-200 border border-black" />
                <div className="absolute -left-1 bottom-1/4 w-3 h-3 rounded-full bg-gray-200 border border-black" />
                
                <div className="grid md:grid-cols-3 gap-8">
                  {/* Left Section - Icon and Timeline */}
                  <div className="md:border-r-2 md:border-dashed md:border-black/20 md:pr-6">
                    <motion.div
                      whileHover={{ scale: 1.1, rotate: 5 }}
                      className="inline-block p-4 border-2 border-black mb-4"
                    >
                      <Code2 size={32} className="text-black" strokeWidth={1.5} />
                    </motion.div>
                    ...
                    <div className="space-y-3 font-mono text-xs">
                      <div className="border border-black p-2 bg-gray-50">
                        ...
                        <div className="pl-5">{exp.period}</div>
                      </div>
                      ...
                      <div className="border border-black p-2 bg-gray-50">
                        ...
                        <div className="pl-5">{exp.location}</div>
                      </div>
                    </div>
                    
                    {/* Barcode-like decoration */}
                    <div className="mt-6 flex gap-px h-12">
                      {[2,4,1,3,2,5,1,4,2,3].map((h, i) => (
                        <div key={i} className="bg-black flex-1" style={{ height: `${h * 20}%` }} />
                      ))}
                    </div>
                  </div>
                  
                  {/* Middle & Right Section - Content */}
                  <div className="md:col-span-2 space-y-4">
                    {/* Title Block */}
                    <div className="border-l-4 border-black pl-4">
                      <h3 className="text-2xl font-bold text-black mb-1 tracking-tight" style={{ fontFamily: 'monospace' }}>
                        {exp.title}
                      </h3>
                      <p className="text-lg text-black/70 font-semibold">{exp.company}</p>
                    </div>
                    
                    {/* Description with sketch underline */}
                    <div className="relative pl-4">
                      ...
                      <svg className="w-full h-1 mt-2" style={{ overflow: 'visible' }}>
                        <motion.path
                          d="M 0 0 Q 50 2, 100 0 T 200 0"
                          stroke="black"
                          strokeWidth="1"
                          fill="none"
                          initial={{ pathLength: 0 }}
                    ...
                    {exp.responsibilities && (
                      <div className="bg-gray-50 border border-black/10 p-4">
                        <div className="text-xs font-mono font-bold mb-3 tracking-wider">KEY DELIVERABLES:</div>
                        <ul className="space-y-2">
                          {exp.responsibilities.map((resp, i) => (
                            <motion.li
                              ...
                              whileInView={{ opacity: 1, x: 0 }}
                              transition={{ delay: idx * 0.15 + 0.1 * i }}
                              className="text-sm text-black/80 flex items-start gap-2 font-mono"
                            >
                    ...
                    {/* Tech Stack - Label Style */}
                    <div>
                      <div className="text-xs font-mono font-bold mb-3 tracking-wider">TECH SPECIFICATIONS:</div>
                      <div className="flex flex-wrap gap-2">
                        {exp.tech.map((t, i) => (
                          <motion.div
                            ...
                            transition={{ delay: idx * 0.15 + 0.05 * i, type: "spring" }}
                            whileHover={{ y: -2 }}
                            className="relative"
                          >
                            <div className="border-2 border-black px-3 py-1.5 bg-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all">
                ...
                <div className="mt-8 pt-4 border-t-2 border-dashed border-black/20 flex justify-between items-center text-xs font-mono text-black/40">
                  <span>DOC-EXP-{String(idx + 1).padStart(3, '0')}</span>
              ...
              {/* Connecting line to next document */}
              {idx < experiences.length - 1 && (
                <motion.div
                  initial={{ scaleY: 0 }}
                  whileInView={{ scaleY: 1 }}
                  transition={{ duration: 0.5, delay: idx * 0.15 + 0.6 }}
                  className="w-px h-12 bg-black mx-auto my-0"
                  style={{ 
                    backgroundImage: 'repeating-linear-gradient(0deg, black, black 5px, transparent 5px, transparent 10px)',
                    transformOrigin: 'top'
                  }}
                />
              )}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 inline-block border-4 border-black px-8 py-4 font-mono text-2xl font-bold"
          style={{ 
