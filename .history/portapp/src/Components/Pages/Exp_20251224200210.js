  ...
  return (
    <section className="min-h-screen bg-[#eef1f5] py-20 px-6">
      <div className="max-w-4xl mx-auto relative">
        ...
        {/* BIG TITLE LEFT-ALIGNED WITH NEUMORPHIC ICON */}
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="mb-16 px-10 py-6 flex items-center justify-between rounded-2xl bg-[#eef1f5]"
          style={{
            boxShadow:
        ...
        >
          {/* Title on the left */}
          <h2 className="text-5xl md:text-6xl font-extrabold text-gray-800 text-left">
            Experience
          </h2>
