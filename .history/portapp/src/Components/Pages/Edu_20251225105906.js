        ...
        <div className="rounded-2xl p-6 bg-white/10 backdrop-blur-md">
          ...
          <div className="relative flex flex-wrap justify-center gap-x-12 gap-y-16">
            ...
            {education.map((item, idx) => (
              ...
              >
                {/* Image Orb (larger size) */}
                <div className="w-28 h-28 rounded-full bg-white/60 backdrop-blur-xl border-2 border-white/40 shadow-[0_0_40px_rgba(0,0,0,0.3)] overflow-hidden flex items-center justify-center">
                  <img
                    src={item.image}
                    alt={item.title}
