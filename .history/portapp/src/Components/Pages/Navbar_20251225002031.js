...
// Make sure you import your calligraphy font in index.css or _app.js
// Example: import "@fontsource/dancing-script"; or in tailwind config: extend fontFamily
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <motion.div
            ...
            className="text-4xl md:text-5xl font-extrabold font-calligraphy bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent"
          >
            DS
          </motion.div>
