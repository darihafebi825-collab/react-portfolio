        ...
        <div className="flex gap-3 overflow-x-auto scrollbar-hide py-4">
          {projects.map((project, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="w-[280px] flex-shrink-0 bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow flex flex-col"
            >
              <div className="h-40 bg-gradient-to-br from-gray-900 to-gray-700 flex items-center justify-center text-5xl">
                {project.image}
              </div>

              <div className="p-5 flex flex-col flex-grow">
                <div className="text-xs text-gray-900 uppercase tracking-wider mb-2 font-semibold">
                  {project.category}
                </div>
                <h3 className="text-lg font-bold text-gray-900 mb-2 line-clamp-1">{project.title}</h3>
                <p className="text-gray-600 text-sm mb-3 leading-snug line-clamp-2">{project.description}</p>

                <div className="mb-3">
                  <div className="text-xs text-gray-900 uppercase tracking-wider mb-1.5 font-semibold">Key Features</div>
                ...
                <div className="flex gap-2 mt-auto">
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-gray-900 text-white rounded text-xs font-medium">
                    <Github size={14} /> Code
                  </motion.a>
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-white border-2 border-gray-900 text-gray-900 rounded text-xs font-medium">
