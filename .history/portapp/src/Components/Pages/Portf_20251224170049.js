...
//   const contactInfo = [
//     { icon: Mail, label: 'Email', value: 'darihafebi825@gmail.com', link: 'mailto:darihafebi825@gmail.com' },
//     { icon: Phone, label: 'Phone', value: '+1 (555) 123-4567', link: 'tel:+91 98948 38860' },
//     { icon: MapPin, label: 'Location', value: 'Kanyakumari, Chemparuthivilai', link: '#' }
//   ];
...
//     icon: Linkedin, 
//     label: 'LinkedIn', 
//     url: 'www.linkedin.com/in/dariha-suresh-262a933a0', // <- your LinkedIn link
//     color: 'hover:bg-blue-600' 
//   },
//   { 
//     icon: Github, 
//     label: 'GitHub', 
//     url: 'https://github.com/yourusername', // <- your GitHub link
//     color: 'hover:bg-gray-800' 
//   },
//   { 
//     icon: Instagram, 
//     label: 'Instagram', 
//     url: 'https://www.instagram.com/yourusername', // <- your Instagram link
