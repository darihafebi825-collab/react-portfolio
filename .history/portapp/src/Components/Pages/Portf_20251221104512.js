      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-3 bg-slate-100 px-6 py-3 rounded-full mb-6">
            ...
            <span className="text-slate-700 font-semibold">Professional Journey</span>
          </div>
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto">
            A chronological showcase of my professional growth and achievements
          </p>
        </motion.div>
            ...
            {experiences.map((exp, idx) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute left-0 w-16 h-16 bg-white border-4 border-slate-300 rounded-full flex items-center justify-center shadow-lg"
                >
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="flex flex-wrap gap-3 mb-5">
                    <span className="flex items-center gap-2 bg-slate-50 px-4 py-2 rounded-lg text-sm font-medium text-slate-700 border border-slate-200">
                      <Calendar size={16} />
                      {exp.period}
                    </span>
                    <span className="flex items-center gap-2 bg-slate-50 px-4 py-2 rounded-lg text-sm font-medium text-slate-700 border border-slate-200">
                  ...
                  {/* Description */}
                  <p className="text-slate-600 mb-5 pl-4 border-l-2 border-slate-300 leading-relaxed">
                    {exp.description}
                  </p>

                  {/* Responsibilities */}
                  {exp.responsibilities && (
                    <div className="mb-5 bg-slate-50 rounded-xl p-5 border border-slate-100">
                      <h4 className="text-sm font-bold text-slate-700 mb-3 uppercase tracking-wide">Key Contributions</h4>
                  ...
                  {/* Tech stack */}
                  <div>
                    <h4 className="text-xs font-bold text-slate-500 mb-3 uppercase tracking-wide">Technologies Used</h4>
                    <div className="flex flex-wrap gap-2">
                      {exp.tech.map((t, i) => (
                        <span key={i} className="px-3 py-1.5 bg-slate-100 text-slate-700 text-xs rounded-lg font-medium border border-slate-200 hover:bg-slate-200 transition-colors">
                          {t}
                        </span>
                      ))}
                    </div>
