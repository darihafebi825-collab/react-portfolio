                  ...
                  >
                    ...
                    {hoveredIndex === index && (
                      <motion.button
                        ...
                        className="px-4 py-2 text-black font-semibold text-sm transition-all cursor-pointer"
                        style={{
                          background: '#ffffff',
...
export default function App() {
  ...
  description: "Responsive restaurant frontend website with modern UI, menu sections, and smooth user interactions",
  tags: ["HTML", "CSS", "JavaScript"],
  image: "https://images.unsplash.com/photo-1600891964599-f61ba0e24092?w=400&h=600&fit=crop",
  link: "https://darihafebi825-collab.github.io/restaurants-/",
},

   {
  title: "AI-Powered Yoga Pose Detection",
  description: "Computer vision-based system that detects and analyzes yoga poses using real-time video input",
  tags: ["Python", "OpenCV", "Machine Learning"],
  image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600&h=900&fit=crop",
  link: "https://github.com/darihafebi825-collab/yoga-pose-detection",
},

    {
  title: "Water Potability Prediction",
  description: "Machine learning model to predict water drinkability based on chemical and physical parameters",
  tags: ["Python", "Machine Learning", "Data Analysis"],
  image: "https://images.unsplash.com/photo-1509395176047-4a66953fd231?w=600&h=900&fit=crop",
  link: "https://github.com/darihafebi825-collab/water-potability",
},
    {
  title: "Hospital Management System",
  description: "Web-based hospital management system to manage patients, doctors, appointments, and medical records efficiently",
  tags: ["Django", "SQLite", "HTML", "CSS"],
  image: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&h=900&fit=crop",
  link: "https://github.com/darihafebi825-collab/hospital-management",
},
    {
  title: "Movie Rating Management System",
  description: "Web application to manage movies, user ratings, reviews, and average scores using a Django-based backend",
  tags: ["Django", "HTML", "CSS", "SQLite"],
  image: "https://images.unsplash.com/photo-1517602302552-471fe67acf66?w=600&h=900&fit=crop",
  link: "https://github.com/darihafebi825-collab/movie-rating-system",
},
    
    {
  title: "React Code Debugger",
  description: "Interactive React-based debugging tool to identify component errors, state issues, and render problems in real time",
  tags: ["React", "JavaScript", "Debugging", "Developer Tools"],
  image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=600&h=900&fit=crop",
  link: "https://darihafebi825-collab.github.io/Reactdebugger/",
},
   {
  title: "First Portfolio Website",
  description: "Responsive personal portfolio built using React to showcase projects, skills, and contact information with a clean UI",
  tags: ["React", "JavaScript", "CSS"],
  image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=900&fit=crop",
  link: "https://darihafebi825-collab.github.io/Portfolio/",
},
  ];
 ...
 return (
  ...
  >
    <div className="absolute top-8 left-1/2 transform -translate-x-1/2 text-center z-10">
      <h1
        className="text-5xl font-bold text-gray-900 mb-2 tracking-tight"
        style={{
          textShadow:
