...
const About = () => {
  return (
    <section
      id="about"
      className="bg-white py-36 px-6 flex justify-center"
    >
      <motion.div
        ...
        className="max-w-4xl w-full border-l-4 border-yellow-400 pl-10 rounded-xl shadow-xl"
      >
        {/* Small heading */}
        ...
        <h3 className="text-4xl font-bold text-gray-900 mb-6">
          Who is <span className="text-yellow-400">Dariha?</span>
        </h3>

        {/* Description */}
        <p className="text-lg text-gray-600 leading-relaxed mb-10">
          I’m a passionate AI Product Developer focused on crafting web
          applications with clean design and efficient code. Skilled in
          front-end, back-end, and Machine Learning (OpenCV, MediaPipe). I blend
          technical precision with creativity to build intelligent and visually
          engaging solutions.
        </p>

        {/* Highlights */}
        <div className="flex flex-wrap gap-8 mb-12">
          <span className="text-yellow-400 font-semibold border-b-2 border-yellow-400 pb-1">
            Full Stack (Python)
          </span>
          <span className="text-yellow-400 font-semibold border-b-2 border-yellow-400 pb-1">
        ...
        {/* CV Button */}
        <a
          href="/resume/daruz.pdf"
          target="_blank"
          rel="noopener noreferrer"
        >
          <button className="bg-yellow-400 text-white px-8 py-3 rounded-full font-semibold hover:scale-105 transition">
            Preview CV
          </button>
        </a>
      </motion.div>
