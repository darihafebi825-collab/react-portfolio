  ...
  return (
    <section className="min-h-screen bg-gray-50 relative py-20 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
        ...
        {/* Right Side: Profile Image + Floating Skill Icons */}
        <div className="relative flex justify-center items-center min-h-[500px]">
          ...
          <motion.div
            ...
            className="relative w-[350px] h-[450px] bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-white flex items-center justify-center"
          >
            <div className="w-48 h-48 rounded-full bg-gray-300 flex items-center justify-center text-6xl">
              👤
            </div>
          </motion.div>
