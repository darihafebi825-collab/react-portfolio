            ...
            >
              ...
              <div className="p-4 flex flex-col flex-grow bg-gray-200 shadow-neu-inner">
                ...
                <div className="flex gap-2 mt-auto">
                  ...
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gray-200 text-gray-900 rounded shadow-neu-inner font-medium border border-gray-300">
