      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            ...
            <div className="relative p-10 border-l-4 border-gray-900">
              <div className="space-y-6">
                <div>
                  <h3 className="text-3xl font-bold text-gray-900 mb-2">Dariha</h3>
            ...
            <div className="bg-gray-50 p-10 flex items-center justify-center">
              <div className="grid grid-cols-2 gap-4 w-full">
                {[
                  ...
                  >
                    <stat.icon className="mx-auto mb-3 text-gray-900" size={32} />
