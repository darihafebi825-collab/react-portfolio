      ...
      >
        ...
        <div className="rounded-2xl p-6 bg-white/10 backdrop-blur-md">
          ...
          <div className="text-center mb-16 md:mb-20">
            <h2 className="text-4xl md:text-5xl font-bold flex justify-center items-center gap-3 flex-wrap">
          ...
          <div className="relative flex flex-wrap justify-center gap-x-12 gap-y-16">
            ...
            {/* Curved path background for large screens */}
            ...
            {education.map((item, idx) => (
              ...
              >
                ...
                {/* Year */}
                <div className="mt-4 text-lg font-semibold text-gray-700">{item.year}</div>

                {/* Glass Card */}
                <motion.div
                  whileHover={{ y: -12 }}
                  className="mt-6 w-full sm:w-64 md:w-72 p-6 rounded-2xl text-center
