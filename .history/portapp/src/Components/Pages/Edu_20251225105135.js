...
const education = [
  ...
  },
  {
    ...
    period: "2022 – 2025",
    score: "CGPA: 67.8%",
    image: "/Images/ba-english.png",
  },
];
c:\Users\Dariha A\OneDrive\Desktop\myportfolio\dapp\src\Images\alagappa.png
        ...
        <div className="rounded-2xl p-6 bg-white/10 backdrop-blur-md">
          ...
          <div className="relative flex flex-wrap justify-center gap-x-12 gap-y-16">
            ...
            {education.map((item, idx) => (
              ...
              >
                {/* Icon Orb */}
                <div className="w-20 h-20 rounded-full bg-white/60 backdrop-blur-xl border-2 border-white/40 shadow-[0_0_40px_rgba(0,0,0,0.3)] flex items-center justify-center text-3xl">
                  {item.icon}
                </div>
