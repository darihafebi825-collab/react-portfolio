...
export default function App() {
  ...
  return (
    <div className="w-screen h-screen bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300">
      <div className="absolute top-8 left-1/2 transform -translate-x-1/2 text-center z-10">
        <h1 className="text-5xl font-bold text-gray-900 mb-2 tracking-tight">Project Showcase</h1>
        <p className="text-gray-700 text-lg">Drag to explore • Hover for details</p>
      </div>
