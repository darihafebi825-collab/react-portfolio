    ...
    <section id="projects" className="py-24 bg-gray-200 flex justify-center">
      <div className="max-w-7xl mx-auto px-6 w-full">
        ...
        >
          ...
          <p className="text-gray-700 max-w-2xl mt-4 shadow-neu p-4 rounded-xl bg-gray-200">
        ...
        <div className="flex gap-6 overflow-x-auto scrollbar-hide py-4">
          {projects.map((project, idx) => (
            <motion.div
              ...
              className="w-80 flex-shrink-0 bg-gray-200 rounded-2xl shadow-neu overflow-hidden flex flex-col border border-black"
            >
              {/* Project Image/Icon */}
              <div className="h-36 flex items-center justify-center text-6xl rounded-t-2xl shadow-neu-inner bg-gray-200 text-black">
                {project.image}
              </div>
              ...
              <div className="p-4 flex flex-col flex-grow bg-gray-200 shadow-neu-inner">
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {project.tech.slice(0, 3).map((t, i) => (
                    <span key={i} className="px-2 py-1 bg-gray-200 text-black text-sm rounded shadow-neu-inner">
                      {t}
                    </span>
                  ))}
                </div>
                ...
                <div className="flex gap-2 mt-auto">
                  ...
                  <motion.a whileHover={{ scale: 1.05 }} href="#"
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gray-200 text-gray-900 rounded shadow-neu-inner font-medium border border-black">
                    <Github size={16} /> Code
                  </motion.a>
                  {/* Demo Button with stronger black outline */}
