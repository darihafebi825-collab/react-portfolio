  ...
  return (
    <section id="experience" className="py-24 bg-gradient-to-b from-gray-100 to-gray-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* Vertical Layout - Content Left, Topic Right */}
            ...
            >
              <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    <span className={`flex items-center gap-1.5 bg-gradient-to-r ${exp.color} text-white px-3 py-1.5 rounded-lg text-sm font-medium shadow-md`}>
                      <MapPin size={14} />
                      {exp.location}
                    </span>
                  </div>
                  ...
                  {/* Description */}
                  <p className="text-base text-gray-700 mb-4 pl-4 border-l-4 border-gray-900 italic leading-relaxed">
                    {exp.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.tech.map((t, i) => (
                      <motion.span
                        ...
                        className="px-3 py-1.5 bg-gray-900 text-white text-sm rounded-lg font-medium shadow-md hover:shadow-xl transition-shadow"
                      >
                        {t}
                      </motion.span>
                    ))}
                ...
                >
                  <div className="relative">
                    ...
                    <motion.div
                      ...
                      className={`absolute -top-3 -left-3 w-12 h-12 bg-gradient-to-br ${exp.color} rounded-full flex items-center justify-center font-bold text-xl text-white shadow-xl z-10`}
                    >
                      {idx + 1}
                    </motion.div>
                    
                    <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-xl border-2 border-gray-200">
                      {/* Icon */}
                      <motion.div
                        whileHover={{ rotate: 360 }}
                        transition={{ duration: 0.6 }}
                        className={`bg-gradient-to-br ${exp.color} p-4 rounded-xl shadow-lg inline-block mb-4`}
                      >
                      ...
                      <motion.div 
                        ...
                        className={`h-1 bg-gradient-to-r ${exp.color} mt-4 rounded-full`}
                      />
                    </div>
                  </div>
                </motion.div>
              ...
              {idx < experiences.length - 1 && (
                <motion.div
                  ...
                  className="hidden md:block absolute left-1/2 bottom-0 w-0.5 h-16 bg-gradient-to-b from-gray-400 to-transparent transform translate-y-full"
