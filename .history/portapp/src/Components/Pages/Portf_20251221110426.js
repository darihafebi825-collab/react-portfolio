      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, idx) => (
            ...
            >
              {/* Project Image/Icon */}
              <div className="h-56 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 flex items-center justify-center text-7xl relative overflow-hidden">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="inline-block mb-3">
                  <span className="text-xs text-gray-900 uppercase tracking-wider font-bold bg-gray-100 px-3 py-1 rounded-full">
                    {project.category}
                  </span>
                </div>
                ...
                {/* Key Features */}
                <div className="mb-4">
                  <div className="text-xs text-gray-900 uppercase tracking-wider mb-2 font-bold">
                    Key Features
                  </div>
                  <div className="space-y-1.5">
                    {project.features.slice(0, 3).map((feature, i) => (
                      <div key={i} className="text-sm text-gray-700 flex items-start gap-2">
                        <Star size={14} className="text-gray-900 flex-shrink-0 mt-0.5" />
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  {project.tech.slice(0, 4).map((t, i) => (
                    <span
                      key={i}
                      className="px-3 py-1.5 bg-gray-900 text-white text-xs rounded-full font-semibold"
                    >
                      {t}
                    </span>
                  ))}
                ...
                <div className="flex gap-3 mt-auto">
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    href="#"
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-white border-2 border-gray-900 text-gray-900 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-colors"
                  >
