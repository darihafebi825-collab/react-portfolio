...
import { Github, Linkedin, Twitter, Instagram, Mail, Phone, MapPin, ExternalLink, Menu, X, Briefcase, Code2, GraduationCap, Award, Zap, Calendar, User, MessageSquare, Send, ChevronRight, Briefcase, Code2, Calendar, MapPin, ChevronRight, ChevronLeft  Star } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-3 bg-slate-100 px-6 py-3 rounded-full mb-6">
            ...
            <span className="text-slate-700 font-semibold">Career Journey</span>
          </div>
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto">
            Navigate through my professional milestones
          </p>
        </motion.div>
        ...
        <div className="relative mb-16">
          ...
          <motion.div 
            className="absolute top-12 left-0 h-1 bg-slate-700"
            initial={{ width: 0 }}
            ...
            {experiences.map((exp, idx) => (
              ...
              >
                ...
                >
                  <Code2 
                    size={32} 
                    className={idx <= activeIndex ? 'text-white' : 'text-slate-400'}
                  />
                </motion.div>

                {/* Step number */}
                <div className={`mt-3 px-3 py-1 rounded-full text-sm font-bold ${
                  idx === activeIndex 
                ...
                {/* Company name */}
                <p className="mt-2 text-xs font-semibold text-slate-700 text-center max-w-[120px]">
                  {exp.company}
                </p>
              </motion.div>
            ))}
            ...
            <div className="grid md:grid-cols-2 gap-10">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-6">
                  <span className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg text-sm font-medium text-slate-700 border border-slate-300">
                    <Calendar size={16} />
                ...
                <p className="text-slate-600 leading-relaxed pl-4 border-l-4 border-slate-300">
              ...
              <div className="space-y-6">
                {/* Responsibilities */}
                {experiences[activeIndex].responsibilities && (
                  <div className="bg-slate-50 rounded-xl p-6 border border-slate-100">
                    ...
                    <ul className="space-y-3">
                      {experiences[activeIndex].responsibilities.map((resp, i) => (
                        ...
                        >
                          <ChevronRight size={16} className="mt-0.5 flex-shrink-0 text-slate-500" />
                          <span>{resp}</span>
                        </motion.li>
                      ))}
                    </ul>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {experiences[activeIndex].tech.map((t, i) => (
                      <motion.span
                        ...
                        className="px-3 py-2 bg-white text-slate-700 text-sm rounded-lg font-medium border border-slate-300 hover:border-slate-400 hover:shadow-md transition-all"
                      >
                        {t}
                      </motion.span>
                    ))}
