...
import { Github, Linkedin, Twitter, Instagram,Briefcase, Code2, Calendar, MapPin, ChevronRight Mail, Phone, MapPin, ExternalLink, Menu, X, Briefcase, Code2, GraduationCap, Award, Zap, Calendar, User, MessageSquare, Send, ChevronRight, Star } from 'lucide-react';
  ...
  return (
    <section id="experience" className="py-24 bg-gradient-to-b from-gray-100 to-gray-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* 3D Floor View - Cards lying on ground */}
        <div className="relative" style={{
          perspective: '1500px',
          perspectiveOrigin: 'center 30%'
        }}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16" style={{
            transformStyle: 'preserve-3d',
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {/* 3D depth - card thickness */}
                    <div 
                      className={`absolute top-0 right-0 w-full h-full bg-gradient-to-br ${exp.color} opacity-30 rounded-xl`}
                      style={{
                        transform: 'translateZ(-15px)',
                      }}
                    />
                    <div 
                      className={`absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-br from-gray-300 to-gray-400 rounded-xl`}
                      style={{
                        transform: 'translateZ(-20px)',
                      }}
                    />
